...
class HillFit(object):
    ...
    def __init__(self, x_data: Union[List[float], np.ndarray], y_data: Union[List[float], np.ndarray]) -> None:
    ...
    def fitting(self, x_label: str = 'x', y_label: str = 'y', title: str = 'Fitted Hill equation', sigfigs: int = 6, view_figure: bool = True):
    ...
    def export(self, export_directory: Optional[str] = None, export_name: Optional[str] = None) -> None:
        ...
        string = '\n'.join(
            [
                ...
                f'top = {self.top}', f'bottom = {self.bottom}',
                f'ec50 = {self.ec50}',
                f'nH = {self.nH}',
            ],
        )
