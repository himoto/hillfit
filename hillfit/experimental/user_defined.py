...
class UserDefined(object):
    def __init__(
        ...
        """Fitting user-defined function to Experimental Data.
        ...
        equation : Callable
            User defined function to be fitted.
        """
    ...
    def fitting(
        ...
        x_label: str = "x",
        y_label: str = "y",
        title: str = "User-defined function",
        sigfigs: int = 6,
        log_x: bool = False,
        ...
        if export:
            self.export(params, export_directory, export_name, generate_figure)
    ...
    def export(
        ...
        # export the popt
        arg_names = self._equation.__code__.co_varnames[:self._equation.__code__.co_argcount][1:]
        string = "\n".join(
            [
